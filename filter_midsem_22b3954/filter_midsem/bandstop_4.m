...
freqs_to_check = [105, 110, 175, 180];
mag_values = abs(interp1(f, H, freqs_to_check));  % Interpolating magnitude values

% Display the results
fprintf('Magnitude at 105 Hz: %.4f\n', mag_values(1));
fprintf('Magnitude at 110 Hz: %.4f\n', mag_values(2));
fprintf('Magnitude at 175 Hz: %.4f\n', mag_values(3));
fprintf('Magnitude at 180 Hz: %.4f\n', mag_values(4));
